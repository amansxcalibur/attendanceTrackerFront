  ...
  return (
    <div className={`h-[94vh] scroll-smooth`}>
      ...
      <div className="flex flex-col items-center justify-center -mt-[8vw]">
        <Image src={Dashboard} className="h-[30vw] w-auto border-[0.4vw] rounded-[1vw] border-[#979797] border-solid"/>
      ...
      <div className="flex flex-col justify-center items-center mt-[50vh]">
        <Image src={Dashboard} className="w-[60vw] h-auto sticky top-[50vh] -translate-y-1/2 mb-[20vw]"/>
        <Image src={EditTable} className="w-[60vw] h-auto sticky top-[50vh] -translate-y-1/2 mb-[20vw]"/>
        <div className="w-[60vw] h-[30vw] flex justify-center items-center rounded-[2vw] bg-[#1c1c1c] sticky top-[50vh] -translate-y-1/2 mb-[20vw]">Ranked bunking here</div>
      </div>
      <div id='feature'>
        <Feature/>
      </div>

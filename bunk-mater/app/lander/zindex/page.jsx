...
export default function CircleScale(){
    ...
    return(
        ...
        <div className="h-[50vh] flex justify-center items-center"></div>
        <motion.div className="fixed top-[50vh] translate-y-1/2 bg-white min-h-10 min-w-10" style={{scaleX: scrollYProgress, scaleY: scrollYProgress}}></motion.div>

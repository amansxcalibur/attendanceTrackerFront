...
export default function HorizontalScroll({activate,setActivate}){
  ...
  return(
    <div className='h-[800vh] flex justify-center flex-col overflow-x-hidden'>
      ...
      <div className={`${activate?"fixed bottom-0":"block"}`}>
        <div ref={ref} className={`bg-white text-black text-[3vw]  flex justify-center items-center`} 
        style={{transform: `translateX(-${scrollerX}px)`}}
        >
          <div ref={startRef} className='h-[100vh] w-2 bg-blue-600'></div>
            <p className='w-[400vh] h-screen'>(Your text goes here. Your text goes here. Your text goes here. Your text goes here.)</p>

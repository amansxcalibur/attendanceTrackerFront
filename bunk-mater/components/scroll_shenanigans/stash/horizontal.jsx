...
export default function HorizontalScroll({activate,setActivate}){
  ...
  return(
    <>
      ...
      <div className='flex items-end w-[500vw] bg-white text-black text-3xl h-[100vh]'>
        <div ref={ref} className='w-[100vw] h-full bg-blue-500'></div>
        <p ref={whiteRef} className='h-full bg-red-600'
        //style={{transform: `translateX(-${scrollerX}px)`}}
        >Text goes here Text goes here Text goes here Text goes here Text goes here Text goes here Text goes here Text goes here Text goes here</p>
